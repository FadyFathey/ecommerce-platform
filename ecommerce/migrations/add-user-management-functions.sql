-- Additional Database Functions for Full User Management
-- Run this in your Supabase SQL Editor to enable delete, update email, and update user details
...
-- ============================================
-- Function 3: Update User Details (name, phone, etc.)
-- ============================================
...
-- Grant execute permission
GRANT EXECUTE ON FUNCTION update_user_details(UUID, TEXT, TEXT, TEXT) TO authenticated;
...
AND routine_name IN ('delete_user', 'update_user_email', 'update_user_details', 'get_user_by_id');
