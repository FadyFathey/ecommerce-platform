...
-- Run this in your Supabase SQL Editor to enable UI-based user role management
...
-- Grant execute permission to authenticated users
GRANT EXECUTE ON FUNCTION update_user_role_by_email(TEXT, TEXT) TO authenticated;

-- ============================================
-- Set your email as admin (fadyfathymaher3@gmail.com)
-- ============================================
...
WHERE email = 'fadyfathymaher3@gmail.com';
